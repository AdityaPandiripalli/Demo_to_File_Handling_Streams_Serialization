...
namespace Demo_to_File_Handling_Streams_Serialization
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string filePath = @"C:\Users\adity\source\repos\Wipro Training\Demo_to_File_Handling_Streams_Serialization\Demo_to_File_Handling_Streams_Serialization\bin\Debug\employees.json"; // Defining the file path where the JSON string will be written
